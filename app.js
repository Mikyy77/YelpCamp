    ...
    helmet.contentSecurityPolicy({
        directives: {
            ...
            imgSrc: [
                ...
                "blob:",
                "data:",
                "https://res.cloudinary.com/dwduspj1h/", //SHOULD MATCH YOUR CLOUDINARY ACCOUNT! 
...
app.use((req, res, next) => {
    ...
    res.locals.success = req.flash('success') // you have access to res.locals.variable everywhere
